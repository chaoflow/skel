...
beautiful.init(os.getenv("HOME") .. "/.nix-profile/share/awesome/themes/default/theme.lua")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "e",     function () awful.util.spawn("e") end),
    ...
    awful.key({}, "XF86AudioRaiseVolume", function () exec("amixer -q sset Master 2%+", false) end),
    awful.key({}, "XF86AudioLowerVolume", function () exec("amixer -q sset Master 2%-", false) end),
    awful.key({}, "XF86AudioMute", function () exec("amixer -q sset Master toggle", false) end),
    awful.key({}, "XF86AudioStop", function () exec("mpc stop", false) end),
    awful.key({}, "XF86AudioPlay", function () exec("mpc toggle", false) end),
    awful.key({}, "XF86AudioPrev", function () exec("mpc prev", false) end),
    awful.key({}, "XF86AudioNext", function () exec("mpc next", false) end),
    --awful.key({}, "XF86Launch1", function () exec("") end),
...
function dropdown_toggle(prog, height, s)
    if prog == nil then prog = terminal end
